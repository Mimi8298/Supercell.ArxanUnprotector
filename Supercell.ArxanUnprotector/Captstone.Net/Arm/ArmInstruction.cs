...
///     ARM Instruction.
/// </summary>
public sealed class ArmInstruction : Instruction<ArmInstruction, ArmInstructionDetail, ArmDisassembleMode,
    ArmInstructionGroup, ArmInstructionGroupId, ArmInstructionId, ArmRegister, ArmRegisterId>
{
    /// <summary>
    ...
    {
        ArmInstructionBuilder builder = new ArmInstructionBuilder();
