...
/// </summary>
internal sealed class ArmInstructionDetailBuilder : InstructionDetailBuilder<ArmInstructionDetail, ArmDisassembleMode,
    ArmInstructionGroup, ArmInstructionGroupId, ArmInstruction, ArmInstructionId, ArmRegister, ArmRegisterId>
{
    /// <summary>
    ...
    internal override void Build(CapstoneDisassembler disassembler, NativeInstructionHandle hInstruction)
    {
        ...
        NativeArmInstructionDetail nativeInstructionDetail =
            NativeCapstone.GetInstructionDetail<NativeArmInstructionDetail>(hInstruction).GetValueOrDefault();

        ConditionCode = nativeInstructionDetail.ConditionCode;
        CpsFlag = nativeInstructionDetail.CpsFlag;
        CpsMode = nativeInstructionDetail.CpsMode;
        IsUserMode = nativeInstructionDetail.IsUserMode;
        MemoryBarrierOperation = nativeInstructionDetail.MemoryBarrierOperation;
        Operands = ArmOperand.Create(disassembler, ref nativeInstructionDetail);
        UpdateFlags = nativeInstructionDetail.UpdateFlags;
        VectorDataType = nativeInstructionDetail.VectorDataType;
        VectorSize = nativeInstructionDetail.VectorSize;
        WriteBack = nativeInstructionDetail.WriteBack;
    }
    ...
    /// </returns>
    private protected override ArmInstructionGroup CreateInstructionGroup(CapstoneDisassembler disassembler,
        byte instructionGroupId)
    {
