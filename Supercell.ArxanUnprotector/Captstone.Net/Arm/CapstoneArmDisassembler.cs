...
/// </summary>
public sealed class CapstoneArmDisassembler : CapstoneDisassembler<ArmDisassembleMode, ArmInstruction,
    ArmInstructionDetail, ArmInstructionGroup, ArmInstructionGroupId, ArmInstructionId, ArmRegister, ArmRegisterId>
{
    /// <summary>
    ...
    /// </exception>
    public CapstoneArmDisassembler(ArmDisassembleMode disassembleMode) : base(DisassembleArchitecture.Arm,
        disassembleMode)
    {
    }
    ...
    private protected override ArmInstruction CreateInstruction(NativeInstructionHandle hInstruction)
    {
        ...
        ArmInstruction instruction = ArmInstruction.Create(this, hInstruction);
        return instruction;
    }
}