...
/// </summary>
internal sealed class Arm64InstructionDetailBuilder : InstructionDetailBuilder<Arm64InstructionDetail,
    Arm64DisassembleMode, Arm64InstructionGroup, Arm64InstructionGroupId, Arm64Instruction, Arm64InstructionId,
    Arm64Register, Arm64RegisterId>
{
    /// <summary>
    ...
    internal override void Build(CapstoneDisassembler disassembler, NativeInstructionHandle hInstruction)
    {
        ...
        NativeArm64InstructionDetail nativeInstructionDetail = NativeCapstone.GetInstructionDetail<NativeArm64InstructionDetail>(hInstruction).GetValueOrDefault();

        ConditionCode = nativeInstructionDetail.ConditionCode;
        Operands = Arm64Operand.Create(disassembler, (Arm64InstructionId) nativeInstruction.Id,
            ref nativeInstructionDetail);
    ...
    /// </returns>
    private protected override Arm64InstructionGroup CreateInstructionGroup(CapstoneDisassembler disassembler,
