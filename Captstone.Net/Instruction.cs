    ...
    where TRegisterId : Enum
{
    ...
    private protected Instruction(
        InstructionBuilder<TDetail, TDisassembleMode, TGroup, TGroupId, TSelf, TId, TRegister, TRegisterId> builder)
    {
    ...
    /// </summary>
    public InstructionBytes Bytes { get; }
    ...
    public string Mnemonic
    {
        get
        {
            ...
            CapstoneDisassembler.ThrowIfValueIsNullReference(nameof(_mnemonic), _mnemonic);
    ...
    public string Operand
    {
        ...
        {
            CapstoneDisassembler.ThrowIfDietModeIsEnabled();
            CapstoneDisassembler.ThrowIfValueIsNullReference(nameof(_operand), _operand);
            return _operand;
        }
    }
}