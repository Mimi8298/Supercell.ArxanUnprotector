...
internal static class NativeCapstoneImport
{
    ...
    internal static extern NativeCapstoneResultCode CreateDisassembler(DisassembleArchitecture disassembleArchitecture,
        NativeDisassembleMode disassembleMode, ref IntPtr pDisassembler);
    ...
    internal static extern IntPtr Disassemble(NativeDisassemblerHandle hDisassembler, IntPtr pCode, nint codeSize,
        long startingAddress, nint count, ref IntPtr pInstructions);
    ...
    internal static extern void FreeInstructions(IntPtr pInstructions, nint count);
    ...
    internal static extern NativeCapstoneResultCode GetAccessedRegisters(NativeDisassemblerHandle hDisassembler,
        NativeInstructionHandle hInstruction, IntPtr readRegisters, ref byte readRegistersCount,
        IntPtr writtenRegisters, ref byte writtenRegistersCount);
    ...
    [SuppressGCTransition]
    internal static extern IntPtr GetInstructionGroupName(NativeDisassemblerHandle hDisassembler,
    ...
    [SuppressGCTransition]
    internal static extern bool Iterate(NativeDisassemblerHandle hDisassembler, ref byte pCode, ref nint codeSize, ref long address, NativeInstructionHandle hInstruction);
    ...
    internal static extern NativeCapstoneResultCode SetDisassemblerOption(NativeDisassemblerHandle hDisassembler,
        NativeDisassemblerOptionType optionType, IntPtr optionValue);
}