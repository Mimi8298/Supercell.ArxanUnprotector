...
/// </summary>
public sealed class CapstoneArm64Disassembler : CapstoneDisassembler<Arm64DisassembleMode, Arm64Instruction,
    Arm64InstructionDetail, Arm64InstructionGroup, Arm64InstructionGroupId, Arm64InstructionId, Arm64Register,
    Arm64RegisterId>
{
    /// <summary>
    ...
    /// </exception>
    public CapstoneArm64Disassembler(Arm64DisassembleMode disassembleMode) : base(DisassembleArchitecture.Arm64,
        disassembleMode)
    {
    }
    ...
    private protected override Arm64Instruction CreateInstruction(NativeInstructionHandle hInstruction)
    {
        ...
        Arm64Instruction instruction = Arm64Instruction.Create(this, hInstruction);
        return instruction;
    }
}