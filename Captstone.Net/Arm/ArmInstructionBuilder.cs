...
/// </summary>
internal sealed class ArmInstructionBuilder : InstructionBuilder<ArmInstructionDetail, ArmDisassembleMode,
    ArmInstructionGroup, ArmInstructionGroupId, ArmInstruction, ArmInstructionId, ArmRegister, ArmRegisterId>
{
    ...
    /// </returns>
    private protected override ArmInstructionDetail CreateDetails(CapstoneDisassembler disassembler,
